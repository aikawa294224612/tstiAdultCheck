...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:RiskAssessment/f:identifier</sch:title>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:RiskAssessment/f:prediction">
      <sch:assert test="count(f:probability[x]) &gt;= 1">probability[x]: minimum cardinality of 'probability[x]' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
